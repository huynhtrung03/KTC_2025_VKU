...
// File: src/main/java/com/example/employee_management/controllers/EmployeeController.java
...
public class EmployeeController {
    ...
    @GetMapping
    public Pagination<EmployeeResponseDto> getAllEmployees(
            @RequestParam(value = "page", defaultValue = "0") int page,
            @RequestParam(value = "size", defaultValue = "10") int size) {
        return employeeService.getAllEmployees(page, size);
    }

    // API để lấy thông tin một nhân viên theo ID
